<template>
    ...
    <div>
        ...
        <!-- Button One -->
        <div class="margin-bottom-md">
            <p class="margin-bottom-xxs">Button One</p>
        ...
        <div class="margin-bottom-md">
            ...
            <div class="form-group margin-bottom-xxxs">
                <label class="form-label margin-bottom-xxs">Variant</label>
                <div class="select">
                    <select v-model="block.data.buttons[1].variant" name="variant" id="variant" class="select_input form-control width-100%">
                        <option value="primary" key="primary" :selected="block.data.buttons[1].variant === 'primary'">Primary</option>
                        <option value="accent" key="accent" :selected="block.data.buttons[1].variant === 'accent'">Accent</option>
                        <option value="subtle" key="subtle" :selected="block.data.buttons[1].variant === 'subtle'">Subtle</option>
                    </select>
                    <svg class="select__icon" aria-hidden="true" viewBox="0 0 16 16"><polyline points="1 5 8 12 15 5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>
                </div>
            </div>
